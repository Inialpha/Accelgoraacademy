...
const Main = () => {
    return (
        <>
            <main id='main' className="p-12 relative h-[80vh] md:h-[60vh] font-apercu lg:p-24 ">
                <div className='w-full lg:w-1/2'>
                    ...
                    <p className='font-fira text-lg text-gray-500 mt-4'>
                        Unlock your potential, improve your<br/> 
                        career or skill with our self-paced courses led <br />
